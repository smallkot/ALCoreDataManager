...
// ALCoreDataManager
#define COCOAPODS_POD_AVAILABLE_ALCoreDataManager
#define COCOAPODS_VERSION_MAJOR_ALCoreDataManager 0
#define COCOAPODS_VERSION_MINOR_ALCoreDataManager 1
#define COCOAPODS_VERSION_PATCH_ALCoreDataManager 2
